...
all:		# Makes reqmod plugin, then respmod plugin
	...
	g++ -shared -nostdlib /usr/lib/x86_64-linux-gnu/crti.o /usr/lib/gcc/x86_64-linux-gnu/5/crtbeginS.o src/fg_reqmod.o -L/usr/local/lib /usr/lib/x86_64-linux-gnu/libecap.so -L/usr/lib/gcc/x86_64-linux-gnu/4.7 -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../../x86_64-linux-gnu -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../../../lib -L/lib/x86_64-linux-gnu -L/lib/../lib -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../.. -lstdc++ -lm -lc -lgcc_s /usr/lib/gcc/x86_64-linux-gnu/5/crtendS.o  /usr/lib/x86_64-linux-gnu/crtn.o -fPIC -Wl,-soname -Wl,fg_reqmod.so -o src/fg_reqmod.so

	g++ -fPIC -DHAVE_CONFIG_H -I../src -I/usr/local/include -O2 -std=c++11 -c src/fg_respmod.cc -o src/fg_respmod.o
	g++ -shared -nostdlib /usr/lib/x86_64-linux-gnu/crti.o /usr/lib/gcc/x86_64-linux-gnu/5/crtbeginS.o src/fg_respmod.o -L/usr/local/lib /usr/lib/x86_64-linux-gnu/libecap.so -L/usr/lib/gcc/x86_64-linux-gnu/4.7 -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../../x86_64-linux-gnu -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../../../lib -L/lib/x86_64-linux-gnu -L/lib/../lib -L/usr/lib/gcc/x86_64-linux-gnu/4.7/../../.. -lstdc++ -lm -lc -lgcc_s /usr/lib/gcc/x86_64-linux-gnu/5/crtendS.o  /usr/lib/x86_64-linux-gnu/crtn.o -fPIC -Wl,-soname -Wl,fg_respmod.so -o src/fg_respmod.so
